...
### Main Pages
- **Homepage** (`index.html`) - Hero section, services overview, location, reviews
- **About Us** (`about.html`) - Founder story, credentials, philosophy
- **Services** (`services.html`) - Detailed Botox, fillers, and rejuvenation info
...
- ✅ HTML, CSS, vanilla JavaScript with Tailwind
...
- **Fast Loading**: Optimized HTML, CSS delivery via CDN
...
### Content Updates
Most content can be updated by editing the HTML files directly. The modular structure makes it easy to update:
